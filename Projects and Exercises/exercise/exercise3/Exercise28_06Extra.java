...
public class Exercise28_06Extra extends Application {
  private Button btDisplayCycle = new Button("Is the graph cyclic?");
  ...
  public void start(Stage primaryStage) {   
    ...
    primaryStage.setTitle("Exercise28_06"); // Set the stage title
  ...
  class View extends Pane {
    ...
    public UnweightedGraphDetectCycle<Vertex> getGraph() {     
      ...
      // Create a graph
      UnweightedGraphDetectCycle<Vertex> graph = new UnweightedGraphDetectCycle<>(list, edges);
      return graph;
    }
    
    public void displayCycle() {     
      if (getGraph().isCyclic()) {
        text.setText("Yes");
      }
      else {
        text.setText("No");
