...
public class Exercise28_11Extra extends Application {
  private Button btDisplayHamiltonianPath = new Button("Display a Hamiltonian Path");
  ...
  public void start(Stage primaryStage) {   
    ...
    hBox1.getChildren().addAll(new Label("Starting vertex: "), tfStartingVertex, btDisplayHamiltonianPath, text);
    ...
    primaryStage.setTitle("Exercise28_11"); // Set the stage title
    primaryStage.setScene(scene); // Place the scene in the stage
    primaryStage.show(); // Display the stage
    
    btDisplayHamiltonianPath.setOnAction(e -> view.displayHamiltonianPath());
  }
  ...
  class View extends Pane {
    ...
    public UnweightedGraphHamiltonianPath<Vertex> getGraph() {     
      ...
      // Create a graph
      UnweightedGraphHamiltonianPath<Vertex> graph = new UnweightedGraphHamiltonianPath<>(list, edges);
      return graph;
    }
    
    public void displayHamiltonianPath() {     
      List<Integer> path = getGraph().getHamiltonianPath(Integer.parseInt(tfStartingVertex.getText()));

      if (path == null) {
        text.setText("No Hamiltonian path found"); 
      }
      else {
        text.setText("A Hamiltonian path found");
      }
