...
public class Exercise28_14Extra extends Application {
  ...
  public void start(Stage primaryStage) {   
    ...
    hBox1.getChildren().addAll(new Label("Starting vertex: "), tfStartingVertex, btDisplayLongestPath, text);
    ...
    primaryStage.setTitle("Exercise28_14"); // Set the stage title
  ...
  class View extends Pane {
    ...
    public void displayLongestPath() {     
      List<Integer> path = getGraph().getLongestPath(Integer.parseInt(tfStartingVertex.getText()));
