...
public class Exercise28_03Extra extends Application {
  ...
  public void start(Stage primaryStage) {   
    ...
    primaryStage.setTitle("Exercise28_03"); // Set the stage title
  ...
  class View extends Pane {
    ...
    public Graph<Vertex> getGraph() {     
      ...
      // Create a graph
      Graph<Vertex> graph = new UnweightedGraph<>(list, edges);
      return graph;
    }
