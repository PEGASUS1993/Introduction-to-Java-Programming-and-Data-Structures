...
public class Exercise28_09Extra extends Application {
  private Button btGetBipartiteSet = new Button("Display bipartite sets ");
  ...
  public void start(Stage primaryStage) {   
    ...
    hBox.getChildren().addAll(btGetBipartiteSet, text);
    
    pane.setBottom(hBox);
    
    // Create a scene and place it in the stage
    Scene scene = new Scene(pane, 950, 350);
    primaryStage.setTitle("Exercise28_09"); // Set the stage title
    primaryStage.setScene(scene); // Place the scene in the stage
    primaryStage.show(); // Display the stage
    
    btGetBipartiteSet.setOnAction(e -> view.getBipartiteSet());
  }
  ...
  class View extends Pane {
    ...
    public UnweightedGraphGetBipartiteSets<Vertex> getGraph() {     
      ...
      // Create a graph
      UnweightedGraphGetBipartiteSets<Vertex> graph = new UnweightedGraphGetBipartiteSets<>(list, edges);
      return graph;
    }
    
    public void getBipartiteSet() {     
      text.setText("The bipartite sets are " + getGraph().getBipartite());
    }
