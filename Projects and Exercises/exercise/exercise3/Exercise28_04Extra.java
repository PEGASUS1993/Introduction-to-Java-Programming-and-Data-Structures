...
public class Exercise28_04Extra extends Application {
  private Button btDisplayDFS = new Button("Display DFS");
  private Button btDisplayBFS = new Button("Display BFS");
  private Button btDisplayShortestPath = new Button("Display Shortest Path");
  private TextField tfStartingVertex = new TextField();
  private TextField tfStartingVertexForShortestPath = new TextField();
  ...
  public void start(Stage primaryStage) {   
    ...
    hBox1.getChildren().addAll(new Label("Starting vertex: "), tfStartingVertex, btDisplayDFS, btDisplayBFS);
    tfStartingVertex.setPrefColumnCount(2);
    tfStartingVertex.setAlignment(Pos.BASELINE_RIGHT);
    hBox1.setStyle("-fx-border-color: green");
    
    HBox hBox2 = new HBox(5);
    hBox2.getChildren().addAll(new Label("Starting vertex: "), tfStartingVertexForShortestPath, 
      new Label("Ending vertex: "), tfEndingVertexForShortestPath, btDisplayShortestPath);
    tfStartingVertexForShortestPath.setPrefColumnCount(2);
    tfEndingVertexForShortestPath.setPrefColumnCount(2);
    tfStartingVertexForShortestPath.setAlignment(Pos.BASELINE_RIGHT);
    ...
    primaryStage.setTitle("Exercise28_04"); // Set the stage title
    primaryStage.setScene(scene); // Place the scene in the stage
    primaryStage.show(); // Display the stage
    
    btDisplayDFS.setOnAction(e -> view.displayDFS());
    btDisplayBFS.setOnAction(e -> view.displayBFS());
    btDisplayShortestPath.setOnAction(e -> view.displayShortestPath(
        Integer.parseInt(tfStartingVertexForShortestPath.getText()), 
  ...
  class View extends Pane {
    ...
    public Graph<Vertex> getGraph() {     
      ...
      // Create a graph
      Graph<Vertex> graph = new UnweightedGraphWithNonrecursiveDFS<>(list, edges);
      return graph;
    }
    
    public void displayDFS() {     
      UnweightedGraph<Vertex>.SearchTree tree = getGraph().dfs(Integer.parseInt(tfStartingVertex.getText()));
    ...
    public void displayBFS() {     
      UnweightedGraph<Vertex>.SearchTree tree = 
        getGraph().bfs(Integer.parseInt(tfStartingVertex.getText()));
