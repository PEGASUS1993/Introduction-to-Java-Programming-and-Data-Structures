// Exercise33_05Client.java: The client sends the input to the server and receives
...
public class Exercise33_05Client extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    primaryStage.setTitle("Exercise33_05Client"); // Set the stage title
  ...
  public void connectToServer() {
    try {
      ...
      osToServer.writeObject(new Loan(annualInterestRate, numOfYears, loanAmount));
