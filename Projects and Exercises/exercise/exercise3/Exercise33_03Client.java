// Exercise33_03Client.java: The client sends the input to the server and receives
...
public class Exercise33_03Client extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    primaryStage.setTitle("Exercise33_03Client"); // Set the stage title
