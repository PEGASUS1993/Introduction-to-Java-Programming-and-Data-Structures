...
public class Exercise28_12Extra extends Application {
  ...
  public void start(Stage primaryStage) {   
    ...
    hBox1.getChildren().addAll(btDisplayHamiltonianPath, text);
    ...
    primaryStage.setTitle("Exercise28_12"); // Set the stage title
  ...
  class View extends Pane {
    ...
    public void displayHamiltonianPath() {     
      List<Integer> path = getGraph().getHamiltonianPath();
