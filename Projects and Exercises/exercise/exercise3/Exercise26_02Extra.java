...
public class Exercise26_02Extra {
  public static void main(String[] args) {
    new Exercise26_02Extra();
  }
  
  public Exercise26_02Extra() {
    // Create a AVLTree
  ...
  public static class AVLTree<E> extends BST<E> {
    public boolean isBalanced() {
      return isBalanced((AVLTreeNode<E>)root);
    }
    ...
    public boolean isBalanced(AVLTreeNode<E> node) {
      if (node == null)
        return true;
      if (node.left == null) {
        if (node.right == null || ((AVLTreeNode<E>)(node.right)).height <= 1)
          return true;
        else 
          return false;
      }
      else if (node.right == null) {
        if (node.left == null || ((AVLTreeNode<E>)(node.left)).height <= 1)
          return true;
        else 
          return false;
      }
      else if ((Math.abs(((AVLTreeNode<E>)(node.left)).height - ((AVLTreeNode<E>)(node.right)).height) <= 1))
          return isBalanced((AVLTreeNode<E>)(node.left)) && isBalanced((AVLTreeNode<E>)(node.right));
      else
        return false;
    }
